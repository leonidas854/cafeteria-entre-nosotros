...
import { crearPromocion, editarPromocion, NuevaPromocion, Promocion2 } from '@/src/features/admin/api/Promociones';
import { getProductos, Productos } from '@/src/features/admin/api/Admin';
