...
namespace Cafeteria_back.Migrations
{
    ...
    [Migration("20251125054119_productoid_v3")]
    partial class productoid_v3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cafeteria_back.Entities.Pedidos.Venta", b =>
                {
                    ...
                    b.HasOne("Cafeteria_back.Entities.Pedidos.Pedido", "Pedido")
                        .WithOne("Venta")
                        .HasForeignKey("Cafeteria_back.Entities.Pedidos.Venta", "Pedido_id")
