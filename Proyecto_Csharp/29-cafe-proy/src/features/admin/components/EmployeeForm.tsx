...
import { getRoles } from '@/src/features/admin/api/Admin';
import { registrarEmpleado } from '@/src/features/auth/api/LoginEmpleado';
import toast from 'react-hot-toast';

import { actualizarEmpleado } from '@/src/shared/api/modules/Usuarios';
