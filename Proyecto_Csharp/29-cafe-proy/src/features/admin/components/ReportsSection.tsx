...
} from '@/src/features/menu/api/productos';

import {
  Promocion2,
  Todas_las_Promociones,
  eliminarPromocion,
} from '@/src/features/admin/api/Promociones';
...
import {
  ...
  eliminarCliente,
  eliminarEmpleado,
} from '@/src/shared/api/modules/Usuarios';

import { fetchPedidosConInfoCompleta } from '@/src/features/cajero/api/Pedido';
